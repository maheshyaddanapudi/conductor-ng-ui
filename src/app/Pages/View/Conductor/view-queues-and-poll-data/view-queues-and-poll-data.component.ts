...
@Component({
  selector: 'app-view-queues-and-poll-data',
  templateUrl: './view-queues-and-poll-data.component.html',
  styleUrls: []
})
export class ViewQueuesAndPollDataComponent implements OnInit {
