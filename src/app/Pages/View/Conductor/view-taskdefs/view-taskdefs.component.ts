...
@Component({
  selector: 'app-view-taskdefs',
  templateUrl: './view-taskdefs.component.html',
  styleUrls: []
})
export class ViewTaskdefsComponent implements OnInit {
  ...
  async update(task_name: string){
    this.navigatorVarHolderService.set_task_name(task_name)
