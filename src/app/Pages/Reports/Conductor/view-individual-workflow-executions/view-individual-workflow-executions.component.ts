...
import { WorkflowManagementService, SearchResultWorkflowSummary } from 'src/app/Rest/Conductor';
...
@Component({
  selector: 'app-view-individual-workflow-executions',
  templateUrl: './view-individual-workflow-executions.component.html',
  styleUrls: []
})
export class ViewIndividualWorkflowExecutionsComponent implements OnInit {
  ...
  constructor(private router: Router, private workflowManagementService: WorkflowManagementService, private modalService: NgbModal, private navigatorVarHolderService: NavigatorVarHolderService) { 
