...
@Component({
  selector: 'app-view-workflow-executions',
  templateUrl: './view-workflow-executions.component.html',
  styleUrls: []
})
export class ViewWorkflowExecutionsComponent implements OnInit {
