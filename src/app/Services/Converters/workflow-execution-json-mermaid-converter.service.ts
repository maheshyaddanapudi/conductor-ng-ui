...
import { Task, Workflow, WorkflowDef, WorkflowTask } from 'src/app/Rest/Conductor';

@Injectable({
  providedIn: 'root'
})
export class WorkflowExecutionJsonMermaidConverterService {
  ...
  convert(workflow_def: WorkflowDef, workflow_execution: Workflow): string[]
  {
    ...
    await workflow_execution.tasks.forEach((workflow_execution_task: Task) => {
        ...
        )
      {
        switch(workflow_execution_task.status){
          case 'IN_PROGRESS':
            graph_def_array.push("style "+workflow_execution_task.referenceTaskName+" fill:#ffa600;")
          break;
          case 'FAILED':
            graph_def_array.push("style "+workflow_execution_task.referenceTaskName+" fill:#ff0000;")
          break;
          case 'FAILED_WITH_TERMINAL_ERROR':
            graph_def_array.push("style "+workflow_execution_task.referenceTaskName+" fill:#ff0000;")
          break;
          case 'SKIPPED':
            graph_def_array.push("style "+workflow_execution_task.referenceTaskName+" fill:#00aeff;")
          break;
          case 'CANCELED':
            graph_def_array.push("style "+workflow_execution_task.referenceTaskName+" fill:#00aeff;")
          break;
          case 'COMPLETED':
            graph_def_array.push("style "+workflow_execution_task.referenceTaskName+" fill:#00ff00;")
          break;
          case 'COMPLETED_WITH_ERRORS':
            graph_def_array.push("style "+workflow_execution_task.referenceTaskName+" fill:#00ff40;")
          break;
          case 'TIMED_OUT':
            graph_def_array.push("style "+workflow_execution_task.referenceTaskName+" fill:#ffd000;")
          break;
          case 'SCHEDULED':
            graph_def_array.push("style "+workflow_execution_task.referenceTaskName+" fill:#00aeff;")
          break;
