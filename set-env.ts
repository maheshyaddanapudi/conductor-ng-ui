...
let OAUTH_ENABLED: string = 'Y';
let OAUTH_TOKEN_URL: string = 'http://localhost:9990/auth/realms/master/protocol/openid-connect/token';
...
let OAUTH_CLIENT_SECRET: string = '8782ca99-decc-441a-8988-736350fafe67';
let OAUTH_LOGOUT_URL: string = 'http://localhost:9990/auth/realms/master/protocol/openid-connect/logout';
let LOG_AGGREGATOR_ANALYTICS_IFRAME_URL = 'http://localhost:5601/app/kibana#/dashboard/AXhUih0zRBdJq327omqR?embed=true&_g=(refreshInterval%3A(display%3AOff%2Cpause%3A!f%2Cvalue%3A0)%2Ctime%3A(from%3Anow%2Fd%2Cmode%3Aquick%2Cto%3Anow%2Fd))';
let API_HITS_COUNTER_ANALYTICS_IFRAME_URL = 'http://localhost:5601/app/kibana#/dashboard/AXhWNBvRRBdJq327om7U?embed=true&_g=(refreshInterval%3A(display%3AOff%2Cpause%3A!f%2Cvalue%3A0)%2Ctime%3A(from%3Anow%2Fd%2Cmode%3Aquick%2Cto%3Anow%2Fd))';
